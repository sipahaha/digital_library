    ...
    <div class="row">
      ...
      $ratingDecimal = number_format($rRating['rata'], 1);
        ...
        <div class="col-md-6">
            ...
            <div class="icon">
                <a
                    href="<?php echo isset($_SESSION['id']) ? '?page=koleksi&idkol=' . $rowResult['id_buku'] : 'login.php'; ?>">
                    <button class="btn btn-md"><i class="bi-bookmark" style="font-size: 15px;"></i></button>
                </a>
                <a
                    href="<?php echo isset($_SESSION['id']) ? '?page=pinjam&idpinjam=' . $rowResult['id_buku'] : 'login.php'; ?>">
                    <button class="btn btn-md" style="font-size: 15px;">Pinjam Buku</button>
                </a>
